...
const ApplicantsPerJobPage: FC = () => {
  ...
  const onUpdateApplicant =
    (applicant: IApplicant, type: string) => (event: React.MouseEvent) => {
                  ...
                  <React.Fragment key={applicant.id}>
                    <div className="alerts-content">
                      <div className="row">
                        ...
                        <div className="col-lg-2 col-md-2 col-xs-12">
                          <p>
                            {dayjs(applicant.created_at).format(
                        ...
                        <div className="col-lg-2 col-md-2 col-xs-12">
                          {applicant.status === "Pending" && (
                            <>
                              <button
                                onClick={() =>
                                  onUpdateApplicant(applicant, "accept")
                                }
                              ...
                              <button
                                onClick={() =>
                                  onUpdateApplicant(applicant, "reject")
                                }
